...
var connectRange = function connectRange2(renderFn) {
  ...
  return function(widgetParams) {
    ...
    var getRefinedState = function getRefinedState2(helper, currentRange, nextMin, nextMax) {
    ...
    var createSendEvent = function createSendEvent2(instantSearchInstance) {
      return function() {
    ...
    return {
      ...
      getRenderState: function getRenderState(renderState, renderOptions) {
        return _objectSpread9(_objectSpread9({}, renderState), {}, {
          range: _objectSpread9(_objectSpread9({}, renderState.range), {}, _defineProperty9({}, attribute, this.getWidgetRenderState(renderOptions)))
        });
      },
      getWidgetRenderState: function getWidgetRenderState(_ref13) {
        ...
        return {
          ...
          widgetParams: _objectSpread9(_objectSpread9({}, widgetParams), {}, {
            precision
          }),
          start
        };
      ...
      getWidgetUiState: function getWidgetUiState(uiState, _ref15) {
        ...
        return _objectSpread9(_objectSpread9({}, uiState), {}, {
          range: _objectSpread9(_objectSpread9({}, uiState.range), {}, _defineProperty9({}, attribute, "".concat(min, ":").concat(max)))
        });
      },
...
//# sourceMappingURL=chunk-KCM34GUE.js.map
