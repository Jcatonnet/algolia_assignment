...
var Paper = React27.forwardRef(function Paper2(inProps, ref) {
...
var _excluded9 = ["className", "raised"];
...
var Card = React28.forwardRef(function Card2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsx)(CardRoot, _extends({
    className: clsx_default(classes.root, className),
