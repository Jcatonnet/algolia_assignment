var $leb1U$reactdom = require("react-dom");
var $leb1U$reactaria = require("react-aria");
var $leb1U$react = require("react");
var $leb1U$usesyncexternalstoreshimindexjs = require("use-sync-external-store/shim/index.js");
...
$parcel$export(module.exports, "NodeValue", () => $3114c2382242bdc0$export$f5d856d854e74713);
$parcel$export(module.exports, "BaseCollection", () => $3114c2382242bdc0$export$408d25a4e12db025);
$parcel$export(module.exports, "useCachedChildren", () => $3114c2382242bdc0$export$727c8fc270210f13);
$parcel$export(module.exports, "useCollectionChildren", () => $3114c2382242bdc0$export$901dbff4e54a6dd0);
$parcel$export(module.exports, "useCollection", () => $3114c2382242bdc0$export$6cd28814d92fa9c9);
$parcel$export(module.exports, "useCollectionDocument", () => $3114c2382242bdc0$export$7cd71aa5ddd6dc4e);
$parcel$export(module.exports, "useCollectionPortal", () => $3114c2382242bdc0$export$ad42d5efb4461b31);
$parcel$export(module.exports, "CollectionDocumentContext", () => $3114c2382242bdc0$export$8c25dea96356a8b6);
$parcel$export(module.exports, "CollectionPortal", () => $3114c2382242bdc0$export$813b5978dd974d8);
$parcel$export(module.exports, "useShallowRender", () => $3114c2382242bdc0$export$aeba0b1fb3dcd8b8);
$parcel$export(module.exports, "useSSRCollectionNode", () => $3114c2382242bdc0$export$e7c29ae2353b16ea);
$parcel$export(module.exports, "Section", () => $3114c2382242bdc0$export$6e2c8f0811a474ce);
$parcel$export(module.exports, "CollectionContext", () => $3114c2382242bdc0$export$db36075d98ba73d3);
...
function $3114c2382242bdc0$export$727c8fc270210f13(props) {
    ...
    let cache = (0, $leb1U$react.useMemo)(()=>new WeakMap(), dependencies);
    return (0, $leb1U$react.useMemo)(()=>{
        if (items && typeof children === "function") {
            ...
            for (let item of items){
                ...
                if (!rendered) {
                    ...
                    rendered = /*#__PURE__*/ (0, $leb1U$react.cloneElement)(rendered, addIdAndValue ? {
                        key: key,
                        id: key,
                        value: item
                    } : {
...
const $3114c2382242bdc0$var$ShallowRenderContext = /*#__PURE__*/ (0, $leb1U$react.createContext)(false);
...
function $3114c2382242bdc0$var$useSyncExternalStoreFallback(subscribe, getSnapshot, getServerSnapshot) {
    let isSSR = (0, $leb1U$reactaria.useIsSSR)();
    let isSSRRef = (0, $leb1U$react.useRef)(isSSR);
    // This is read immediately inside the wrapper, which also runs during render.
    // We just need a ref to avoid invalidating the callback itself, which
    // would cause React to re-run the callback more than necessary.
    // eslint-disable-next-line rulesdir/pure-render
    isSSRRef.current = isSSR;
    let getSnapshotWrapper = (0, $leb1U$react.useCallback)(()=>{
        return isSSRRef.current ? getServerSnapshot() : getSnapshot();
    }, [
        getSnapshot,
        getServerSnapshot
    ]);
    return (0, $leb1U$usesyncexternalstoreshimindexjs.useSyncExternalStore)(subscribe, getSnapshotWrapper);
}
const $3114c2382242bdc0$var$useSyncExternalStore = typeof (0, ($parcel$interopDefault($leb1U$react)))["useSyncExternalStore"] === "function" ? (0, ($parcel$interopDefault($leb1U$react)))["useSyncExternalStore"] : $3114c2382242bdc0$var$useSyncExternalStoreFallback;
function $3114c2382242bdc0$export$7cd71aa5ddd6dc4e(initialCollection) {
    // The document instance is mutable, and should never change between renders.
    // useSyncExternalStore is used to subscribe to updates, which vends immutable Collection objects.
    let document = (0, $leb1U$react.useMemo)(()=>new $3114c2382242bdc0$export$b34a105447964f9f(initialCollection || new $3114c2382242bdc0$export$408d25a4e12db025()), [
        initialCollection
    ]);
    let subscribe = (0, $leb1U$react.useCallback)((fn)=>document.subscribe(fn), [
        document
    ]);
    let getSnapshot = (0, $leb1U$react.useCallback)(()=>{
    ...
    let getServerSnapshot = (0, $leb1U$react.useCallback)(()=>{
        document.isSSR = true;
...
const $3114c2382242bdc0$var$SSRContext = /*#__PURE__*/ (0, $leb1U$react.createContext)(null);
const $3114c2382242bdc0$export$8c25dea96356a8b6 = /*#__PURE__*/ (0, $leb1U$react.createContext)(null);
function $3114c2382242bdc0$export$ad42d5efb4461b31(props, document) {
    let ctx = (0, $leb1U$react.useContext)($3114c2382242bdc0$export$8c25dea96356a8b6);
    let doc = document !== null && document !== void 0 ? document : ctx;
    let children = $3114c2382242bdc0$export$901dbff4e54a6dd0(props);
    let wrappedChildren = (0, $leb1U$react.useMemo)(()=>/*#__PURE__*/ (0, ($parcel$interopDefault($leb1U$react))).createElement($3114c2382242bdc0$var$ShallowRenderContext.Provider, {
            value: true
        }, children), [
        children
    ]);
    ...
    return (0, $leb1U$reactaria.useIsSSR)() ? /*#__PURE__*/ (0, ($parcel$interopDefault($leb1U$react))).createElement($3114c2382242bdc0$var$SSRContext.Provider, {
        value: doc
    }, wrappedChildren) : /*#__PURE__*/ (0, $leb1U$reactdom.createPortal)(wrappedChildren, doc);
}
function $3114c2382242bdc0$export$813b5978dd974d8(props) {
    return /*#__PURE__*/ (0, ($parcel$interopDefault($leb1U$react))).createElement((0, ($parcel$interopDefault($leb1U$react))).Fragment, null, $3114c2382242bdc0$export$ad42d5efb4461b31(props));
}
function $3114c2382242bdc0$export$aeba0b1fb3dcd8b8(type, props, ref) {
    let isShallow = (0, $leb1U$react.useContext)($3114c2382242bdc0$var$ShallowRenderContext);
    var _useSSRCollectionNode;
    if (isShallow) // Elements cannot be re-parented, so the context will always be there.
    // eslint-disable-next-line react-hooks/rules-of-hooks
    return (_useSSRCollectionNode = $3114c2382242bdc0$export$e7c29ae2353b16ea(type, props, ref, "children" in props ? props.children : null)) !== null && _useSSRCollectionNode !== void 0 ? _useSSRCollectionNode : /*#__PURE__*/ (0, ($parcel$interopDefault($leb1U$react))).createElement((0, ($parcel$interopDefault($leb1U$react))).Fragment, null);
    return null;
}
function $3114c2382242bdc0$export$636783d3732b5559(props, ref, rendered) {
    ...
    return (0, $leb1U$react.useCallback)((element)=>{
...
function $3114c2382242bdc0$export$e7c29ae2353b16ea(Type, props, ref, rendered, children) {
    ...
    let parentNode = (0, $leb1U$react.useContext)($3114c2382242bdc0$var$SSRContext);
    if (parentNode) {
        ...
        return children ? /*#__PURE__*/ (0, ($parcel$interopDefault($leb1U$react))).createElement($3114c2382242bdc0$var$SSRContext.Provider, {
            value: element
        }, children) : null;
    }
    // @ts-ignore
    return /*#__PURE__*/ (0, ($parcel$interopDefault($leb1U$react))).createElement(Type, {
        ref: itemRef
    }, children);
}
...
const $3114c2382242bdc0$export$6e2c8f0811a474ce = /*#__PURE__*/ (0, $leb1U$react.forwardRef)($3114c2382242bdc0$var$Section);
const $3114c2382242bdc0$export$db36075d98ba73d3 = /*#__PURE__*/ (0, $leb1U$react.createContext)(null);
const $3114c2382242bdc0$export$4feb769f8ddf26c5 = /*#__PURE__*/ (0, $leb1U$react.createContext)(null);
function $3114c2382242bdc0$export$fb8073518f34e6ec(props) {
    let ctx = (0, $leb1U$react.useContext)($3114c2382242bdc0$export$db36075d98ba73d3);
    props = (0, $leb1U$reactaria.mergeProps)(ctx, props);
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($leb1U$react))).createElement($3114c2382242bdc0$export$4feb769f8ddf26c5.Provider, {
        value: renderer
