...
function $132cbde493282f82$var$GridList(props, ref) {
    ...
    let { collection: collection, portal: portal } = (0, $3114c2382242bdc0$exports.useCollection)(props);
    return /*#__PURE__*/ (0, ($parcel$interopDefault($UaDUV$react))).createElement((0, ($parcel$interopDefault($UaDUV$react))).Fragment, null, portal, /*#__PURE__*/ (0, ($parcel$interopDefault($UaDUV$react))).createElement($132cbde493282f82$var$GridListInner, {
        props: props,
...
function $132cbde493282f82$var$GridListInner({ props: props, collection: collection, gridListRef: ref }) {
    ...
    let { gridProps: gridProps } = (0, $UaDUV$reactaria.useGridList)(props, state, ref);
    let children = (0, $3114c2382242bdc0$exports.useCachedChildren)({
        items: collection,
        children: (item)=>{
            switch(item.type){
                case "item":
                    return /*#__PURE__*/ (0, ($parcel$interopDefault($UaDUV$react))).createElement($132cbde493282f82$var$GridListRow, {
                        item: item
                    });
                default:
    ...
    }, isListDroppable && /*#__PURE__*/ (0, ($parcel$interopDefault($UaDUV$react))).createElement($132cbde493282f82$var$RootDropIndicator, null), children), emptyState, dragPreview));
}
/**
 ...
 */ const $132cbde493282f82$export$e96fc9a8407faa6b = /*#__PURE__*/ (0, $UaDUV$react.forwardRef)($132cbde493282f82$var$GridListItem);
function $132cbde493282f82$var$GridListRow({ item: item }) {
    ...
    let { dragAndDropHooks: dragAndDropHooks, dragState: dragState, dropState: dropState } = (0, $UaDUV$react.useContext)((0, $368d79437ab76c11$exports.DragAndDropContext));
    let ref = (0, $UaDUV$reactariautils.useObjectRef)(item.props.ref);
    ...
    let renderDropIndicator = (dragAndDropHooks === null || dragAndDropHooks === void 0 ? void 0 : dragAndDropHooks.renderDropIndicator) || ((target)=>/*#__PURE__*/ (0, ($parcel$interopDefault($UaDUV$react))).createElement((0, $368d79437ab76c11$exports.DropIndicator), {
            target: target
        }));
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($UaDUV$react))).createElement((0, ($parcel$interopDefault($UaDUV$react))).Fragment, null, (dragAndDropHooks === null || dragAndDropHooks === void 0 ? void 0 : dragAndDropHooks.useDropIndicator) && renderDropIndicator({
        type: "item",
        key: item.key,
        dropPosition: "before"
    }), dropIndicator && !dropIndicator.isHidden && /*#__PURE__*/ (0, ($parcel$interopDefault($UaDUV$react))).createElement("div", {
        role: "row",
        style: {
            position: "absolute"
        }
...
function $132cbde493282f82$var$GridListDropIndicatorWrapper(props, ref) {
    ...
    let { dragAndDropHooks: dragAndDropHooks, dropState: dropState } = (0, $UaDUV$react.useContext)((0, $368d79437ab76c11$exports.DragAndDropContext));
