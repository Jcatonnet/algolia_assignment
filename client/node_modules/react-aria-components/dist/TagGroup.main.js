...
function $ecf55d0c218a575e$var$TagList(props, forwardedRef) {
    ...
    let portal = (0, $3114c2382242bdc0$exports.useCollectionPortal)(props);
    return /*#__PURE__*/ (0, ($parcel$interopDefault($4TsYs$react))).createElement((0, ($parcel$interopDefault($4TsYs$react))).Fragment, null, portal, /*#__PURE__*/ (0, ($parcel$interopDefault($4TsYs$react))).createElement($ecf55d0c218a575e$var$TagListInner, {
        props: props,
...
function $ecf55d0c218a575e$var$TagListInner({ props: props, forwardedRef: forwardedRef }) {
    ...
    let children = (0, $3114c2382242bdc0$exports.useCachedChildren)({
        ...
        children: (item)=>{
            switch(item.type){
                case "item":
                    return /*#__PURE__*/ (0, ($parcel$interopDefault($4TsYs$react))).createElement($ecf55d0c218a575e$var$TagItem, {
                        item: item
                    });
                default:
 ...
 */ const $ecf55d0c218a575e$export$3288d34c523a1192 = /*#__PURE__*/ (0, $4TsYs$react.forwardRef)($ecf55d0c218a575e$var$Tag);
function $ecf55d0c218a575e$var$TagItem({ item: item }) {
    let state = (0, $4TsYs$react.useContext)((0, $a03b42240404b420$exports.ListStateContext));
    let ref = (0, $4TsYs$reactariautils.useObjectRef)(item.props.ref);
