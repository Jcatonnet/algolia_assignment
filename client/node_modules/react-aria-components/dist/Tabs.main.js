...
function $f982e6cd1aac14a3$var$Tabs(props, ref) {
    ...
    let { collection: collection, document: document } = (0, $3114c2382242bdc0$exports.useCollectionDocument)();
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement((0, ($parcel$interopDefault($ke4kY$react))).Fragment, null, /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement((0, $c5ccf687772c0422$exports.Hidden), null, /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement((0, $3114c2382242bdc0$exports.CollectionDocumentContext).Provider, {
        value: document
    }, children)), /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement($f982e6cd1aac14a3$var$TabsInner, {
        props: props,
...
function $f982e6cd1aac14a3$var$TabList(props, ref) {
    let document = (0, $ke4kY$react.useContext)((0, $3114c2382242bdc0$exports.CollectionDocumentContext));
    return document ? /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement((0, $3114c2382242bdc0$exports.CollectionPortal), props) : /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement($f982e6cd1aac14a3$var$TabListInner, {
        props: props,
        forwardedRef: ref
    });
}
function $f982e6cd1aac14a3$var$TabListInner({ props: props, forwardedRef: ref }) {
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement("div", {
        ...
        ...state.collection
    ].map((item)=>/*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement($f982e6cd1aac14a3$var$TabInner, {
            key: item.key,
            item: item,
            state: state
        })));
 ...
 */ const $f982e6cd1aac14a3$export$3e41faf802a29e71 = /*#__PURE__*/ (0, $ke4kY$react.forwardRef)($f982e6cd1aac14a3$var$Tab);
function $f982e6cd1aac14a3$var$TabInner({ item: item, state: state }) {
    let ref = (0, $ke4kY$reactariautils.useObjectRef)(item.props.ref);
 ...
 */ const $f982e6cd1aac14a3$export$3d96ec278d3efce4 = /*#__PURE__*/ (0, $c5ccf687772c0422$exports.createHideableComponent)($f982e6cd1aac14a3$var$TabPanel);
