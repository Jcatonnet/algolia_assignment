...
@media (forced-colors: active) {
  .PBsjDW_spectrum-FocusRing, .PBsjDW_spectrum-FocusRing-ring, .PBsjDW_spectrum-FocusRing--quiet {
    --spectrum-high-contrast-focus-ring-color: Highlight;
  }

  :is(.PBsjDW_spectrum-FocusRing, .PBsjDW_spectrum-FocusRing-ring, .PBsjDW_spectrum-FocusRing--quiet):after {
...
/*# sourceMappingURL=vars.7b6f8dc5.css.map */
