...
function $86ed235c4695ff3f$var$SubmenuTrigger(props) {
    let triggerRef = (0, $esjnM$react.useRef)();
    ...
    let { popoverContainer: popoverContainer, trayContainerRef: trayContainerRef, menu: parentMenuRef, submenu: menuRef, rootMenuTriggerState: rootMenuTriggerState, state: state } = (0, $cac834c4bc0a51d3$exports.useMenuStateContext)();
