...
@media (forced-colors: active) {
  .F-oYUa_spectrum-FocusRing, .F-oYUa_spectrum-FocusRing-ring, .F-oYUa_spectrum-FocusRing--quiet {
    --spectrum-high-contrast-focus-ring-color: Highlight;
  }

  :is(.F-oYUa_spectrum-FocusRing, .F-oYUa_spectrum-FocusRing-ring, .F-oYUa_spectrum-FocusRing--quiet):after {
...
/*# sourceMappingURL=vars.28c6b2d1.css.map */
